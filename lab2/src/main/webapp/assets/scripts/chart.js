...
function drawSquare() {
	...
	// I
	ctx.fillRect(CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2, CANVAS_CHARTS_WIDTH / 2, -CANVAS_CHARTS_HEIGHT / 4);

	// II
	let region = new Path2D();
	region.moveTo(CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2);
	region.lineTo(CANVAS_WIDTH / 2 - CANVAS_CHARTS_WIDTH / 4, CANVAS_HEIGHT / 2);
	region.lineTo(CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 - CANVAS_CHARTS_HEIGHT / 4);
	region.closePath();
	...
	ctx.ellipse(CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2, CANVAS_CHARTS_WIDTH / 4, CANVAS_CHARTS_HEIGHT / 4, 0, 0.5 * Math.PI, 1 * Math.PI);
    ctx.closePath();
	ctx.fill();
}
